...
import (
	...
	"github.com/rodrigo-brito/redis/internal"
	"github.com/rodrigo-brito/redis/internal/consistenthash"
	"github.com/rodrigo-brito/redis/internal/hashtag"
...
func (c *Ring) Pipeline() RedisPipilineInterface {
	pipe := Pipeline{
		exec: c.pipelineExec,
	}
...
func (c *Ring) Pipelined(fn func(RedisPipilineInterface) error) ([]Cmder, error) {
